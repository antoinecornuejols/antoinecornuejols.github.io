...
from minimax_2 import MiniMax_2
...
class Connect4Game(Observable):
    def __init__(
        ...
        elif player1 == MINIMAX_2:
            self._player1 = MiniMax_2(self, depth=depth1, pruning=pruning1)
        else:
        ...
        elif player2 == MINIMAX_2:
            self._player2 = MiniMax_2(self, depth=depth2, pruning=pruning2)
        else:
