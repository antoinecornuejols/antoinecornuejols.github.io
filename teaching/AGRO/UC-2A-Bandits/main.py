...
import time
from common import MONTE_CARLO, MINIMAX, MINIMAX_2, RANDOM, SQUARE_SIZE
# from common import MONTE_CARLO, MINIMAX, RANDOM, SQUARE_SIZE, RANDOM_IMPR
import sys
import argparse
...
def main():
    ...
    parser.add_argument(
        ...
        required=True,
        choices=("minimax", "minimax2", "mcts", "random", "human"),
        default="minimax",
    )
    parser.add_argument(
        "--player2",
        ...
        required=True,
        choices=("minimax", "minimax2", "mcts", "random"),
        default="MCTS",
    )
    ...
    # Change to True if one wants to play
        ...
        if args.player2 == "random":
            ...
            p[1] = MINIMAX
        elif args.player2 == "minimax2":
            p[1] = MINIMAX_2
        elif args.player2 == "mcts":
            p[1] = MONTE_CARLO
    
        game = Connect4Game(p[0], p[1], iteration=1000, depth1=5, depth2=5)
