from bot import Bot
import copy
from common import MINIMAX, MINIMAX_2, EMPTY, ROW_COUNT, COLUMN_COUNT, WINDOW_LENGTH
import random
import math
...
class MiniMax_2(Bot):
    ...
    def __init__(self, game, depth, pruning=True):
        super().__init__(game, bot_type=MINIMAX_2, depth=depth, pruning=pruning)
    ...
    def minimax_2(self, board, depth, alpha, beta, maximizingPlayer, pruning):
        """
